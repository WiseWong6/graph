...
exports.simpleLlmNode2 = simpleLlmNode2;
...
// 测试节点 2：使用快速响应配置
function simpleLlmNode2(state) {
    return __awaiter(this, void 0, void 0, function () {
        var config, client, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("[simple_llm_2] Generating with fast config...");
                    config = (0, llm_js_1.getNodeLLMConfig)("simple_llm_2");
                    console.log("[simple_llm_2] Model:", config.model, "temperature:", config.temperature);
                    client = new llm_client_js_1.LLMClient(config);
